...
char* StrPair::ParseText( char* p, const char* endTag, int strFlags )
{
    ...
    char* start = p;	// fix-me: hides a member
    char  endChar = *endTag;
...
XMLNode* XMLText::ShallowClone( XMLDocument* doc ) const
{
    ...
    XMLText* text = doc->NewText( Value() );	// fix-me: this will always allocate memory. Intern?
...
XMLNode* XMLComment::ShallowClone( XMLDocument* doc ) const
{
    ...
    XMLComment* comment = doc->NewComment( Value() );	// fix-me: this will always allocate memory. Intern?
    return comment;
}
...
XMLNode* XMLDeclaration::ShallowClone( XMLDocument* doc ) const
{
    ...
    XMLDeclaration* dec = doc->NewDeclaration( Value() );	// fix-me: this will always allocate memory. Intern?
    return dec;
}
...
XMLNode* XMLUnknown::ShallowClone( XMLDocument* doc ) const
{
    ...
    XMLUnknown* text = doc->NewUnknown( Value() );	// fix-me: this will always allocate memory. Intern?
    return text;
}
...
XMLNode* XMLElement::ShallowClone( XMLDocument* doc ) const
{
    ...
    XMLElement* element = doc->NewElement( Value() );					// fix-me: this will always allocate memory. Intern?
    for( const XMLAttribute* a=FirstAttribute(); a; a=a->Next() ) {
        element->SetAttribute( a->Name(), a->Value() );					// fix-me: this will always allocate memory. Intern?
    }
    return element;
}
